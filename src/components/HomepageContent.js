		...
		<div>
			<div className="main-content">
				...
				<div className="home-content">
					<h1 className="title animate__animated animate__fadeInRight animate__delay-1s">WELCOME TO OBSKUR MUSIC</h1>
				</div>
				<div className="top-content animate__animated animate__fadeInLeft animate__delay-1s">
